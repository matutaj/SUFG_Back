...
export { criarFornecedorSchema, listarFornecedorPeloNome, atualizarFornecedorSchema, deletarFornecedorSchema, listarFornecedorPeloIdSchema, listarFornecedorEmailSchema, listarFornecedorTelefoneSchema, listarFornecedorNumeroContribuinteSchema };