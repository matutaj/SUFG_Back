...
import { RelatorioControlador } from "../../src/model/relatorio/casoDeUso/listarRelatorios/ListarRelatorioController";
...
relatorioRouter.get("/vendas-cliente/:idCliente", relatorioControlador.handle);
...
relatorioRouter.get("/caixas/:idCaixa?", relatorioControlador.handle);
