/*
  ...
  - You are about to drop the column `adicionado` on the `entradasestoque` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE `entradasestoque` DROP COLUMN `adicionado`;
